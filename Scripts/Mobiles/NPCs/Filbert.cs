...
namespace Server.Items
{
    public class WizardsCompendium : BaseCollectionMobile
    {
            ...
            : base("Filbert", "the mage")
        {
            ...
            this.DonationLabel = 1073442; // Wizard's Compendium Section Donation Representative.
        }
        ...
        public override Collection CollectionID
        {
            get
            {
                return Collection.WizardsCompendium;
            }
        }
        ...
        public override void Init()
        {
            ...
            this.Donations.Add(new CollectionItem(typeof(BlackPearl), 0xF7A, 1015001, 0x0, 1));
            this.Donations.Add(new CollectionItem(typeof(Bloodmoss), 0xF7B, 1015004, 0x0, 1));
            this.Donations.Add(new CollectionItem(typeof(Garlic), 0xF84, 1015021, 0x0, 1));
            this.Donations.Add(new CollectionItem(typeof(Ginseng), 0xF85, 1015009, 0x0, 1));
            this.Donations.Add(new CollectionItem(typeof(MandrakeRoot), 0xF86, 1015013, 0x0, 1));
            this.Donations.Add(new CollectionItem(typeof(Nightshade), 0xF88, 1015016, 0x0, 1));
            this.Donations.Add(new CollectionItem(typeof(SulfurousAsh), 0xF8C, 1015025, 0x0, 1));
            this.Donations.Add(new CollectionItem(typeof(SpidersSilk), 0xF8D, 1015007, 0x0, 1));
            ...
            this.Donations.Add(new CollectionSpellbook(SpellbookType.Regular, 0xEFA, 1011419, 10));				
            ...
            this.Rewards.Add(new CollectionItem(typeof(WizardsCrystalGlasses), 0x2FB8, 1073374, 0x2B0, 800000.0));				
        }
