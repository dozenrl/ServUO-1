...
namespace Server.Items
{
    public class MaceAndBlade : BaseCollectionMobile
    {
            ...
            : base("Talbart", "the warrior")
        {
            ...
            this.DonationLabel = 1073449; // Mace and Blade Section Donation Representative.
        }
        ...
        public override Collection CollectionID
        {
            get
            {
                return Collection.MaceAndBlade;
            }
        }
        ...
        { 
            ...
            this.AddItem(new BodySash(0x75D));
        }
        ...
        public override void Init()
        {
            ...
            this.Donations.Add(new CollectionItem(typeof(Buckler), 0x1B73, 1074907, 0x0, 9));			
            this.Donations.Add(new CollectionItem(typeof(BattleAxe), 0xF47, 1074908, 0x0, 9));		
            ...
            this.Rewards.Add(new CollectionItem(typeof(MaceAndShieldGlasses), 0x2FB8, 1073381, 0x1DD, 800000.0));				
        }
